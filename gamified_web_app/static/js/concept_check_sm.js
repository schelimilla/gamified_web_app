...
const data = sessionStorage.getItem('string_methods_answered');
        ...
        function updateQuestionAnswered(correct){
            entries.forEach(entry => {
                ...
                if (entry.question_num === carouselItem.getAttribute('question-num')){
                    ...
                    sessionStorage.setItem('string_methods_answered', JSON.stringify(entries));                }
            });
        }
...
function updateProgress(){
    window.addEventListener('load', function() {
        ...
        else if (string_methods_answered_counter > 0){
